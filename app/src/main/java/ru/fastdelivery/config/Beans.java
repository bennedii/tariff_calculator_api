...
public class Beans {
    ...
    @Bean
    public TariffCoordinatesUseCase tariffCoordinatesUseCase(CoordinatesPriceProvider coordinatesPriceProvider){
        return new TariffCoordinatesUseCase(coordinatesPriceProvider);
    }
